...
static struct zmk_behavior_binding zmk_keymap[ZMK_KEYMAP_LAYERS_LEN][ZMK_KEYMAP_LEN] = {COND_CODE_1(
    IS_ENABLED(CONFIG_ZMK_STUDIO), (DT_INST_FOREACH_CHILD_SEP(0, TRANSFORMED_LAYER, (, ))),
